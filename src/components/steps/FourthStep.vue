    ...
    <div class="container flex px-8 justify-center flex-col m-5 w-3/4 mx-auto">
        ...
        <div class="mx-auto w-3/4">
            ...
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8  py-2 px-3 border-b border-r border-gray-500">Plan {{`${plan.name}
                    ${membership.name}`}}
                </div>
            ...
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8 font-bold text-primary py-2 px-3 border-b border-r border-gray-500 text-right">
                    Total
                </div>
