<template>
    <div class="container flex px-8 justify-center flex-col m-5">
        ...
        <div class="mx-auto w-3/4">
            ...
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8  py-2 px-3 border-b border-r border-gray-500">Plan individual gold</div>
                <div class="col-span-4  py-2 px-3 border-b border-gray-500">$171</div>
            </div>
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8  py-2 px-3 border-b border-r border-gray-500">Anexo multiviaje</div>
                <div class="col-span-4  py-2 px-3 border-b border-gray-500">$30</div>
            </div>
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8  py-2 px-3 border-b border-r border-gray-500 text-right">Subtotal</div>
                <div class="col-span-4  py-2 px-3 border-b border-gray-500">$58</div>
            </div>
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8  py-2 px-3 border-b border-r border-gray-500 text-right">IVA</div>
                <div class="col-span-4  py-2 px-3 border-b border-gray-500">$6</div>
            </div>
            <div class="w-full grid grid-cols-12">
                <div class="col-span-8 font-bold text-primary py-2 px-3 border-b border-r border-gray-500 text-right">Total</div>
                <div class="col-span-4  py-2 px-3 border-b border-gray-500">$260</div>
            </div>
