        ...
        methods: {
           ...
           getColorByMembership(plan){
            ...
            setGradientByMembership(plan){
                switch(plan){
                    case 'Silver': return 'linear-gradient(45deg, rgba(131,131,131,1) 0%, rgba(210,210,210,1) 61%, rgba(198,198,198,1) 100%)'
                    case 'Gold': return 'linear-gradient(53deg, rgba(166,123,40,1) 0%, rgba(242,190,94,1) 100%)'
                    case 'Diamond' : return 'linear-gradient(53deg, rgba(63,66,114,1) 0%, rgba(68,83,156,1) 100%)'
                    default: return 'rgb(0,0,0)'
                }
            }
        },
