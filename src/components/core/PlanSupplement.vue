<template>
    <div class=" w-full grid grid-cols-12 gap-2 my-5">
        ...
        <div class="bg-white rounded-b lg:rounded-b-none lg:rounded-r px-4 flex flex-col justify-between leading-normal col-span-10">
            <div class="flex flex-row justify-between leading-normal">
                <div class="w-3/4 px-3 border-r border-gray-300">
                    <div class=" w-full flex justify-center items-start flex-col py-2 pr-2">
                        <div class="text-primary font-bold text-xl ">{{name}}</div>
                        <!--                            <p class="text-gray-700 text-base">{{description}}</p>-->
                    </div>
                    <button class="bg-primary py-1 px-6 hover:bg-secondary text-white rounded-full "
                            @click="moreInformation">Más información
                    </button>
                </div>
...
<script>
    ...
    export default {
        ...
        props: {
            ...
            description: {
                type: String,
                default: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of',
            },
